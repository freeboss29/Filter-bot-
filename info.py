...
API_ID = int(environ.get("API_ID", "26410878"))
API_HASH = environ.get("API_HASH", "3fd13024f9e777877422887da6e1ac28")
...
ADMINS = [
    ...
    for admin in environ.get("ADMINS", "5672857559 6859451629").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "Kumarpmy63"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "Kumarpmy63")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1003862943113").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1003775566380"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1003775566380"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1003714790093"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1003714790093"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1003714790093"))
...
# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1003796841675"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "-1003796841675"))
request_channel = environ.get("REQUEST_CHANNEL", "-1003503062471")
REQUEST_CHANNEL = (
    int(request_channel)
    if request_channel and id_pattern.search(request_channel)
    else None
)
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1003775566380"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/freebosssupport")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/freebossmovie")
...
SHORTENER_API = environ.get("SHORTENER_API", "c3b7322fa5a5dba0b27e345030baa3a4803b418c")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "adlinkpay.in")
SHORTENER_API2 = environ.get(
    "SHORTENER_API2", "c3b7322fa5a5dba0b27e345030baa3a4803b418c"
)
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "adlinkpay.in")
SHORTENER_API3 = environ.get(
    "SHORTENER_API3", "c3b7322fa5a5dba0b27e345030baa3a4803b418c"
)
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "adlinkpay.in")
...
if "DYNO" in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://filter-bot-alyw.onrender.com/")
